...
- (id)initWithSystemId:(uint8_t)systemId componentId:(uint8_t)componentId type:(uint8_t)type autopilot:(uint8_t)autopilot baseMode:(uint8_t)baseMode customMode:(uint32_t)customMode systemStatus:(uint8_t)systemStatus {
  if ((self = [super init])) {
